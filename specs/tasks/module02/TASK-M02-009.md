...
- [x] EdgeType enum added to marblestone.rs with 4 variants
- [x] EdgeType has description(), all(), default_weight() methods
- [x] EdgeType has Default trait (returns Semantic)
- [x] EdgeType has Display trait (lowercase strings)
- [x] EdgeType has Serde with snake_case
- [x] EdgeType has Clone, Copy, Debug, PartialEq, Eq, Hash derives
- [x] 35+ unit tests added and passing (31 tests)
- [x] lib.rs re-exports EdgeType
- [x] graph_edge.rs local EdgeType REMOVED
- [x] graph_edge.rs imports EdgeType from marblestone
- [x] cargo build succeeds
- [x] cargo test succeeds (330 tests)
...
**Test count**: 330 tests passing (31 EdgeType-specific)
**Files modified**:
- `crates/context-graph-core/src/marblestone.rs` - Added EdgeType enum + tests (lines 312-1061)
- `crates/context-graph-core/src/lib.rs` - Added EdgeType to re-exports
- `crates/context-graph-core/src/types/graph_edge.rs` - Removed local EdgeType, added import
